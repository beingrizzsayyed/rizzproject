...
<title>PAID SALE AMMOUNT DATA</title>
...
try
{
	...
	rs=st.executeQuery("select bill_no,total_ammount,payment,date from sale where payment='paid' and cust='"+user+"'");
