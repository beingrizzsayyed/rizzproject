...
<title>UNPAID PURCHASE AMMOUNT</title>
...
try
{
	...
	rs=st.executeQuery("select lable_no,grand_total,payment,date  from purchase where payment='unpaid' and cust='"+user+"' ");
