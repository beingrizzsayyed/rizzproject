...
<title>PAID PURCHASE AMMOUNT DATA</title>
...
try
{
	...
	rs=st.executeQuery("select lable_no,grand_total,payment,date  from purchase where payment='paid' and cust='"+user+"'");
