...
<div id="outer">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav">
            ...
            <a href="unpaidpur.jsp" class="nav-item nav-link">UNPAID PURCHASE</a>
        
             <a href="unpaidsale.jsp" class="nav-item nav-link">UNPAID SALE</a>
   
                <a href="income.jsp" class="nav-item nav-link">ACCOUNT STATEMENT</a>
