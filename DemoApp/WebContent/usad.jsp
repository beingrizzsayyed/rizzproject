...
<title>UNPAID SALE AMMOUNT DATA</title>
...
try
{
	...
	rs=st.executeQuery("select bill_no,advance,ammount,payment,date from sale where payment='unpaid'  and cust='"+user+"' ");
