...
<title>ADD SUB-MERCHANT INFORMATION</title>
...
<div id="outer">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav">
            ...
            <a href="subpurchase.jsp" class="nav-item nav-link active">PURCHASE</a>
       </div></div>
</nav>
...
<form action="Addsub" method="post">
					<table>
					<tr><td colspan=2 style="color:navy;"><B> ADD SUBMERCHANT INFORMATION</B></td></tr>
					<tr><td>SUB-MERCHANT CODE::	</td><td><input type="text" name="scode" size="30"></td></tr>
					<tr><td>SUB-MERCHANT NAME::	</td><td><input type="text" name="name" size="30"></td></tr>
