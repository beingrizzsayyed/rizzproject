...
<div id="outer">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav">
            ...
            <a href="sale.jsp" class="nav-item nav-link active">SALE</a>
       </div></div>
</nav>
...
<form action="Addsub" method="post">
					<table>
					<tr><td colspan=2 style="color:navy;"><B> ADD PARTY INFORMATION</B></td></tr>
					<tr><td>PARTY CODE::	</td><td><input type="text" name="pcode" size="30"></td></tr>
					<tr><td>PARTY NAME::	</td><td><input type="text" name="name" size="30"></td></tr>
